## ================================================================= ##
## BÀI TẬP 4c: DỰ ĐOÁN NHIỆT ĐỘ MARS THEO ÁP SUẤT CHO TỪNG QUỸ ĐẠO   ##
## ================================================================= ##
...
if (!dir.exists("Result/4c")) dir.create("Result/4c")
...
for (orbit in orbits) {
  ...
  model <- poly_regression(
    ...
    h_grid = seq(60, 120, length.out = 50)
  )
  ...
  filename <- sprintf("Result/4c/orbit_%d_temperature_prediction.png", orbit)
...
png("Result/4c/all_orbits_comparison.png", width = 1400, height = 1000, res = 120)
...
png("Result/4c/orbits_grid_3x3.png", width = 1800, height = 1200, res = 120)
